package org.openmrs.module.kenyaemr.helper;
...
public class TestObject {
	...
	public String getUnit(int conceptId) {
		...
		return temp == null ? "" : convertToSup(temp.getUnits());
	}
	...
	private String convertToSup(String input) {
		return input;
	}
	...
	public String calculateRange(String gender, ConceptNumeric concept) {
		...
		if (gender.equalsIgnoreCase("male")) {
			return getValue(concept.getLowCritical()) + "-" + getValue(concept.getHiCritical());
		} else {
			return getValue(concept.getLowNormal()) + "-" + getValue(concept.getHiNormal());
		}
	}
