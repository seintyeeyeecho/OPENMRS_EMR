...
public void controller(@FragmentParam("patient") Patient patient, @FragmentParam("patient") Person person, @SpringBean FormManager formManager, @SpringBean KenyaUiUtils kenyaUi, PageRequest pageRequest, UiUtils ui, FragmentModel model) {
