...
<tbody>
<tr>
<td><input type="button" class="ui-button ui-widget ui-state-default ui-corner-all" id="guide" name="guide" value="Guide" onClick="guideForSwitchRegimen();" /></td>
...
function guideForSwitchRegimen(){
