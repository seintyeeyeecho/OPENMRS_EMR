<%
	...
	ui.includeCss("kenyaemr", "alertify.css")
	ui.includeCss("kenyaemr", "alertify.theme.css")
	ui.includeJavascript("kenyaemr", "kenyaemr.js", 50)
	ui.includeJavascript("kenyaemr", "library/alertify.js")
	ui.includeJavascript("kenyaemr", "test/test.js");
