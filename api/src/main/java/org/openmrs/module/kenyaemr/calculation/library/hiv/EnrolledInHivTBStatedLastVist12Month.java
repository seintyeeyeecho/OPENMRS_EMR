 ...
 */
public class EnrolledInHivTBStatedLastVist12Month extends AbstractPatientCalculation {
	 ...
	 * @should calculate true for patients who's TB status assessed and recorded during their last visit in 12 months
	 */
	@Override
