...
/**
 * Library of HIV related indicator definitions. All indicators require
...
public class HivIndicatorLibrary {
	...
	/**
	 * Number of patients ever enrolled in HIV care (including transfers) up to
	 * ${endDate}
	 * 
	 * @return the indicator
	 */
	...
	/**
	 * Number of patients enrolled in HIV positiveTB received ART up to
	 * ${endDate}
	 * 
	 * @return the indicator
	 */
	...
	/**
	 * Number of patients who were enrolled (excluding transfers) after referral
	 * from the given entry points
	 * 
	 * @return the indicator
	 */
	public CohortIndicator enrolledExcludingTransfersAndReferredFrom(Concept... entryPoints) {
		return cohortIndicator("newly enrolled patients referred from", map(hivCohorts.enrolledExcludingTransfersAndReferredFrom(entryPoints), "onOrAfter=${startDate},onOrBefore=${endDate}"));
	}
	...
	/**
	 * Number of patients who were enrolled (excluding transfers) after referral
	 * from services other than the given entry points
	 * 
	 * @return the indicator
	 */
	public CohortIndicator enrolledExcludingTransfersAndNotReferredFrom(Concept... entryPoints) {
		return cohortIndicator("newly enrolled patients referred from", map(hivCohorts.enrolledExcludingTransfersAndNotReferredFrom(entryPoints), "onOrAfter=${startDate},onOrBefore=${endDate}"));
	}
	...
	public CohortIndicator transferIn() {
		return cohortIndicator("patients Transfer in", map(hivCohorts.transferIn(), "onOrAfter=${startDate},onOrBefore=${endDate}"));
	}
	...
	public CohortIndicator riskFactor1() {
		return cohortIndicator("patients with risk Factor 1", map(hivCohorts.riskFactorsMSM(), "onOrAfter=${startDate},onOrBefore=${endDate}"));
	}

	public CohortIndicator riskFactor2() {
		return cohortIndicator("patients with risk Factor 2", map(hivCohorts.sexWorker(), "onOrAfter=${startDate},onOrBefore=${endDate}"));
	}

	public CohortIndicator riskFactor3() {
		return cohortIndicator("patients with risk Factor 3", map(hivCohorts.hetroSexual(), "onOrAfter=${startDate},onOrBefore=${endDate}"));
	}
	...
	public CohortIndicator riskFactor5() {
		return cohortIndicator("patients with risk Factor 5", map(hivCohorts.bloodTrans(), "onOrAfter=${startDate},onOrBefore=${endDate}"));
	}

	public CohortIndicator riskFactor6() {
		return cohortIndicator("patients with risk Factor 6", map(hivCohorts.riskFactorsMotherToChild(), "onOrAfter=${startDate},onOrBefore=${endDate}"));
	}
	...
	public CohortIndicator died() {
		return cohortIndicator("out come art reason died", map(hivCohorts.died(), "onOrAfter=${startDate},onOrBefore=${endDate}"));
	}
