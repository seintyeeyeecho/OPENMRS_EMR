...
/**
 * Library of ART Drugs related indicator definitions. All indicators require
...
public class ArtIndicatorLibrary {
	...
	public CohortIndicator activeFollowUpOnART() {
		return cohortIndicator("patients who have ever started ART", map(artCohorts.cumulativeActiveFollowUp(), "onOrAfter=${startDate},onOrBefore=${endDate}"));
	}
